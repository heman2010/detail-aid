/*!
 * reveal.js
 * http://umangis.me/reveal-js
 * MIT licensed
 *
 * Copyright (C) 2015 Umang Raghuvanshi, http://umangis.me
 */
(function( root, factory ) {
	...
	function layout() {
		...
		if( dom.wrapper && !isPrintingPDF() ) {
			...
			var maxsz = document.getElementsByClassName('max-sz');
			for (var i in maxsz) {
				  if (maxsz.hasOwnProperty(i)) {
					maxsz[i].style.height = size.height + 'px';
					maxsz[i].style.width = size.width + 'px';
				  }
			}
