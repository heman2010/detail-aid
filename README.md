...
A framework for easily creating beautiful presentations using HTML. [Check out the live demo](http://umangis.me/reveal-js/).

reveal.js comes with a broad range of features including [nested slides](https://github.com/ur0/reveal.js#markup), [Markdown contents](https://github.com/ur0/reveal.js#markdown), [PDF export](https://github.com/ur0/reveal.js#pdf-export), [speaker notes](https://github.com/ur0/reveal.js#speaker-notes) and a [JavaScript API](https://github.com/ur0/reveal.js#api). It's best viewed in a modern browser but [fallbacks](https://github.com/ur0/reveal.js/wiki/Browser-Support) are available to make sure your presentation can still be viewed elsewhere.


#### More reading:
- [Installation](#installation): Step-by-step instructions for getting reveal.js running on your computer.
- [Changelog](https://github.com/ur0/reveal.js/releases): Up-to-date version history.
- [Examples](https://github.com/ur0/reveal.js/wiki/Example-Presentations): Presentations created with reveal.js, add your own!
- [Browser Support](https://github.com/ur0/reveal.js/wiki/Browser-Support): Explanation of browser support and fallbacks.
- [Plugins](https://github.com/ur0/reveal.js/wiki/Plugins,-Tools-and-Hardware): A list of plugins that can be used to extend reveal.js.
...
<section data-markdown>
	<script type="text/template">
		...
		A paragraph with some text and a [link](http://umangis.me).
	</script>
</section>
```
...
Reveal.initialize({
	...
	parallaxBackgroundImage: '', // e.g. "'https://s3.amazonaws.com/umang-static/reveal-js/reveal-parallax-1.jpg'"
...
<section>
  ...
  <iframe data-src="http://umangis.me"></iframe>
  <video>
...
Some libraries, like MathJax (see [#226](https://github.com/ur0/reveal.js/issues/226#issuecomment-10261609)), get confused by the transforms and display states of slides. Often times, this can be fixed by calling their update or render function from this callback.
...
Make sure that the background size is much bigger than screen size to allow for some scrolling. [View example](http://umangis.me/reveal-js/?parallaxBackgroundImage=https%3A%2F%2Fs3.amazonaws.com%2Fumang-static%2Freveal-js%2Freveal-parallax-1.jpg&parallaxBackgroundSize=2100px%20900px).
...
### Fragments
Fragments are used to highlight individual elements on a slide. Every element with the class ```fragment``` will be stepped through before moving on to the next slide. Here's an example: http://umangis.me/reveal-js/#/fragments
...
Here's an example of an exported presentation that's been uploaded to SlideShare: http://www.slideshare.net/ur0/revealjs-300.

1. Open your presentation with `print-pdf` included anywhere in the query string. This triggers the default index HTML to load the PDF print stylesheet ([css/print/pdf.css](https://github.com/ur0/reveal.js/blob/master/css/print/pdf.css)). You can test this with [umangis.me/reveal-js?print-pdf](http://umangis.me/reveal-js?print-pdf).
...
![Chrome Print Settings](https://s3.amazonaws.com/umang-static/reveal-js/pdf-print-settings.png)
...
If you want to add a theme of your own see the instructions here: [/css/theme/README.md](https://github.com/ur0/reveal.js/blob/master/css/theme/README.md).
...
1. Download the latest version of reveal.js from <https://github.com/ur0/reveal.js/releases>
...
4. Clone the reveal.js repository
   ```sh
   $ git clone https://github.com/ur0/reveal.js.git
   ```
